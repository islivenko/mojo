...
gcloud functions deploy $FUNCTION_NAME \
  ...
  --memory=512MB \
  --timeout=300s \
  --set-env-vars="PROJECT_ID=$PROJECT_ID,B24_DOMAIN=mojo.bitrix24.pl,ACCESS_TOKEN_SECRET=b24-access-token,SPA_SPRAWY_ID=1106,SPA_PODSTAWY_POBYTU_ID=1042,SPA_PRACA_ID=1046,SPA_PROCESY_ID=1110,FIELD_SPRAWY_PODSTAWY=ufCrm38_1768737959,FIELD_SPRAWY_PRACA=ufCrm38_1768738112,FIELD_SPRAWY_PROCESY=ufCrm38_1768738413,FIELD_SPRAWY_PODSTAWY_DATES=ufCrm38_1768738011252,FIELD_PODSTAWY_DATA_DO_KIEDY=ufCrm10_1763581700754"
